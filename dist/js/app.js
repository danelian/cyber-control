var myFullpage = new fullpage('#fullpage', {
	...
	navlistItems.forEach((item) => {
			const navlistHeader = item.querySelector('.btn-reset')
			navlistHeader.addEventListener('click', () => {
					const openItem = document.querySelector('.open')
					toggleNavlistItem(item)
					if (openItem && openItem !== item) {
							toggleNavlistItem(openItem)
					}
			})
	})
	const toggleNavlistItem = (item) => {
			const navlistContent = item.querySelector('.sub-menu')
